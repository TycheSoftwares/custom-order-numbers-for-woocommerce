		...
		public function enqueue_scripts() {
			...
			$data = array(
				'reasons'  => array(
					array(
						'id'                => 1,
						'text'              => __( 'I only needed the plugin for a short period.', 'custom-order-numbers-for-woocommerce' ),
						'input_type'        => '',
						'input_placeholder' => '',
					),
					array(
						'id'                => 2,
						'text'              => __( 'I found a better plugin.', 'custom-order-numbers-for-woocommerce' ),
						'input_type'        => 'textfield',
						'input_placeholder' => __( 'Please let us have the plugin\'s name so that we can make improvements', 'custom-order-numbers-for-woocommerce' ),
					),
					array(
						'id'                => 3,
						'text'              => __( 'The plugin is not working.', 'custom-order-numbers-for-woocommerce' ),
						'input_type'        => 'textfield',
						'input_placeholder' => __( 'Please share what was faulty with the plugin so that we may get the issue fixed.', 'custom-order-numbers-for-woocommerce' ),
					),
					array(
						'id'                => 4,
						'text'              => __( 'The plugin is causing issues on my site', 'custom-order-numbers-for-woocommerce' ),
						'input_type'        => 'textfield',
						'input_placeholder' => __( 'We’re sorry! Please tell us about the issues so that we can get them fixed.', 'custom-order-numbers-for-woocommerce' ),
					),
					array(
						'id'                => 6,
						'text'              => __( 'Some features I need are not working as per my expectations', 'custom-order-numbers-for-woocommerce' ),
						'input_type'        => 'textfield',
						'input_placeholder' => __( 'Please tell us about these features.', 'custom-order-numbers-for-woocommerce' ),
					),
					array(
						'id'                => 7,
						'text'              => __( 'The plugin is not compatible with another plugin/theme', 'custom-order-numbers-for-woocommerce' ),
						'input_type'        => 'textfield',
						'input_placeholder' => __( 'We’re sorry! We would like you to tell us the plugin/theme so that we can work on the compatibility.', 'custom-order-numbers-for-woocommerce' ),
					),
					array(
						'id'                => 11,
					...
					array(
						'id'                => 10,
						'text'              => __( 'Other', 'custom-order-numbers-for-woocommerce' ),
						'input_type'        => 'textfield',
						'input_placeholder' => '',
					),
				),
								...
								<div class="ts-modal-dialog">
									<div class="ts-modal-body">
										...
										<div class="ts-modal-panel active" data-panel-id="reasons">
											<h3>
												<strong>
													' . __( 'If you have a moment, please let us know why you are deactivating:', 'custom-order-numbers-for-woocommerce' ) . '
												</strong>
											</h3>
									...
									<div class="ts-modal-footer">
										<a href="javascript:void(0);" class="button button-secondary button-skip-deactivate"> ' . __( 'Skip & Deactivate', 'custom-order-numbers-for-woocommerce' ) . '</a>
										<a href="javascript:void(0);" class="button button-secondary button-deactivate"> ' . __( 'Submit & Deactivate', 'custom-order-numbers-for-woocommerce' ) . '</a>
										<a href="javascript:void(0);" class="button button-primary button-close">' . __( 'Cancel', 'custom-order-numbers-for-woocommerce' ) . '</a>
									</div>
								</div>
							</div>',
			);
