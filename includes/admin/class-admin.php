...
class Admin {
	 ...
	 * @since 1.0
	 */
	public static function is_on_con_page() {
		global $pagenow;
		return 'admin.php' === $pagenow && isset( $_GET['page'] ) && 'wc-settings' === $_GET['page'] && isset ( $_GET['tab'] ) &&  'custom-order-numbers-for-woocommerce' === $_GET['tab']; // phpcs:ignore
	}
